...
> **Hecho posterior, 2026-09-21.** El usuario concedió después la autorización de
> consolidación que esta sección declaraba pendiente. La rama `Task/027.1`, ya publicada en
> `39b6d59`, quedó integrada en `Task/027-Configurar-Cuentas-y-Presupuestos` mediante
> `merge --no-ff`, **conservando su historial completo**. Esta tarea **sigue siendo
> mantenimiento fuera de las 41** y **conserva su historia propia**; lo que cambia es la
> rama por la que se entrega. Detalle en el
> [reporte §17](../task-reports/TASK-027.1-report.md#17-consolidación-en-task027--2026-09-21).
> El texto de arriba **no se reescribe**: describe con exactitud lo que la aprobación del
> addendum autorizaba por sí sola.
